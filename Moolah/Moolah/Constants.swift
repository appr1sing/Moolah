...
struct ColorConstant {
    ...
    static let green = UIColor(red: 62/255.0, green: 195/255.0, blue: 0/255.0, alpha: 1.0)
    static let cyanBlue = UIColor(red: 1/255.0, green: 186/255.0, blue: 239/255.0, alpha: 1.0)
    static let midnight = UIColor(red: 7/255.0, green: 51/255.0, blue: 70/255.0, alpha: 1.0)
}
